...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lista 2 - Ex 4 - Pedro Fleck", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.setVec4("inputColor", 1.0, 0.0, 0.0, 1.0); //enviando cor para variável uniform inputColor
